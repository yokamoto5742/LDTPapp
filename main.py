...
class DropdownItems:
    def __init__(self):
        self.items = {
            'target_achievement': ['概ね達成', '概ね70%達成', '概ね50%達成', '未達成', '該当なし'],
            'diet': ['食事量を適正にする', "塩分量を適正にする", '食物繊維の摂取量を増やす', 'ゆっくり食べる',
                     '間食を減らす', '脂肪の多い食品や甘い物を控える', '揚げ物や炒め物などを減らす', '1日3食を規則正しくとる', '今回は指導の必要なし'],
            'exercise_prescription': ['ウォーキング', 'ストレッチ体操', '筋力トレーニング', '畑仕事', '今回は指導の必要なし'],
            ...
            'daily_activity': ['3000歩', '5000歩', '6000歩', '8000歩', '10000歩','ストレッチ運動を主に行う', '該当なし'],
        }
